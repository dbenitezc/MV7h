...
#     assert not any(u['name'] in ['Ana', 'Camilo'] for u in users), "Usuarios de prueba no eliminados"
    
#     # Verificar tareas
#     tasks = get_tasks()
#     assert not any(t['title'] in ['Terminar laboratorio', 'Prepare presentation'] for t in tasks), "Tareas de prueba no eliminadas"
#     print("✅ Verificación de limpieza completada")

# # Ejecutar verificación después de la prueba principal
# verify_cleanup()
